    ...
    return function e(t, n, r) {
        ...
        20: [function(e, t, n) {
            (function(e) {
                ...
                var fe = 200,
                    ...
                    Ye = /^(?:0|[1-9]\d*)$/,
                    ze = {};
                ze[ke] = ze[Re] = ze[Fe] = ze[De] = ze[Ue] = ze[Ge] = ze[$e] = ze[Be] = ze[Ve] = !0, ze[me] = ze[_e] = ze[Pe] = ze[ve] = ze[je] = ze[be] = ze[Ee] = ze[Te] = ze[xe] = ze[Ie] = ze[Se] = ze[Ne] = ze[Ce] = ze[Ae] = ze[we] = !1;
        ...
        25: [function(e, t, n) {
            ...
            t.exports = function(e) {
                function t(t, n) {
                    ...
                    l = t;
                    var s = o(e, n);
                    p = i(s, e), r.silent || e.map.fire(u.events.MODE_CHANGE, {
                        mode: t
                ...
                function n(t) {
                    ...
                    Object.keys(t).forEach(function(e) {
                        ...
                        d[e] !== t[e] && (n = !0), d[e] = t[e]
                    }), n && e.map.fire(u.events.ACTIONABLE, {
                        actions: d
                    })
                }
                var r = {},
                    o = {},
                    l = u.modes.SIMPLE_SELECT,
                    p = i(c.simple_select(e), e);
                o.drag = function(t) {
                    a(r, {
                        point: t.point,
                        time: (new Date).getTime()
                    }) ? t.originalEvent.stopPropagation() : (e.ui.queueMapClasses({
                        mouse: u.cursors.DRAG
                    }), p.drag(t))
                }, o.mousemove = function(t) {
                    var n = void 0 !== t.originalEvent.buttons ? t.originalEvent.buttons : t.originalEvent.which;
                    if (1 === n) return o.drag(t);
                    var r = s(t, e);
                    t.featureTarget = r, p.mousemove(t)
                    ...
                    var n = s(t, e);
                    t.featureTarget = n, p.mousedown(t)
                }, o.mouseup = function(t) {
                    var n = s(t, e);
                    t.featureTarget = n, a(r, {
                        point: t.point,
                        time: (new Date).getTime()
                    }) ? p.click(t) : p.mouseup(t)
                ...
                o.keydown = function(n) {
                    8 !== n.keyCode && 46 !== n.keyCode || !e.options.controls.trash ? f(n.keyCode) ? p.keydown(n) : 49 === n.keyCode && e.options.controls.point ? t(u.modes.DRAW_POINT) : 50 === n.keyCode && e.options.controls.line_string ? t(u.modes.DRAW_LINE_STRING) : 51 === n.keyCode && e.options.controls.polygon && t(u.modes.DRAW_POLYGON) : (n.preventDefault(), p.trash())
                }, o.keyup = function(e) {
                    f(e.keyCode) && p.keyup(e)
                }, o.zoomend = function() {
                    e.store.changeZoom()
                }, o.data = function(t) {
                    "style" === t.dataType && ! function() {
                        var t = e.setup,
                            n = e.map,
                            r = e.options,
                            o = e.store,
                            i = !!r.styles.find(function(e) {
                                return n.getLayer(e.id)
                            });
                        i || (t.addLayers(), o.setDirty(), o.render())
                    }()
                };
                var d = {
                        trash: !1,
                    ...
                    h = {
                        ...
                        addEventListeners: function() {
                            e.map.on("mousemove", o.mousemove), e.map.on("mousedown", o.mousedown), e.map.on("mouseup", o.mouseup), e.map.on("data", o.data), e.container.addEventListener("mouseout", o.mouseout), e.options.keybindings && (e.container.addEventListener("keydown", o.keydown), e.container.addEventListener("keyup", o.keyup))
                        },
                        removeEventListeners: function() {
                            e.map.off("mousemove", o.mousemove), e.map.off("mousedown", o.mousedown), e.map.off("mouseup", o.mouseup), e.map.off("data", o.data), e.container.removeEventListener("mouseout", o.mouseout), e.options.keybindings && (e.container.removeEventListener("keydown", o.keydown), e.container.removeEventListener("keyup", o.keyup))
                        },
                        trash: function(e) {
                            p.trash(e)
                        },
            ...
            "./lib/is_click": 40,
            "./lib/mode_handler": 43,
            "./modes/direct_select": 52,
            "./modes/draw_line_string": 53,
            "./modes/draw_point": 54,
            "./modes/draw_polygon": 55,
            "./modes/simple_select": 56,
            "./modes/static": 57
        }],
        26: [function(e, t, n) {
            "use strict";
        ...
        34: [function(e, t, n) {
            ...
            function r(e) {
                ...
                var u = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                    ...
                    h = [];
                return p === s.geojsonTypes.POINT ? h.push(o(d, f, c, n(c))) : p === s.geojsonTypes.POLYGON ? f.forEach(function(e, n) {
                    t(e, null !== c ? c + "." + n : String(n))
                }) : p === s.geojsonTypes.LINE_STRING ? t(f, c) : 0 === p.indexOf(s.geojsonTypes.MULTI_PREFIX) && a(), h
            }
        ...
        39: [function(e, t, n) {
            ...
            t.exports = function(e, t) {
                ...
                return n[0] && (i.mouse = n[0].properties.active === o.activeStates.ACTIVE ? o.cursors.MOVE : o.cursors.POINTER, i.feature = n[0].properties.meta), t.events.currentModeName().indexOf("draw") !== -1 && (i.mouse = o.cursors.ADD), t.ui.queueMapClasses(i), t.ui.updateMapClasses(), n[0]
            }
        }, {
            "../constants": 24,
            "./features_at": 38
        ...
        40: [function(e, t, n) {
            ...
            t.exports = function(e, t) {
                ...
                return l < a || l < u && t.time - e.time < c
            }
        }, {
        ...
        52: [function(e, t, n) {
            ...
            t.exports = function(e, t) {
                ...
                var i = t.startPos || null,
                    ...
                    E = function(t) {
                        e.map.dragPan.disable(), m = !0, i = t.lngLat
                    },
                    T = function() {
                        e.map.dragPan.enable(), g = !1, m = !1, i = null
                    },
                    O = function(e) {
                        E(e);
                        var t = e.featureTarget.properties,
                            n = _.indexOf(t.coord_path);
                        a(e) || n !== -1 ? a(e) && n === -1 && _.push(t.coord_path) : _ = [t.coord_path], r.changed()
                    },
                    x = function(e) {
                        E(e);
                        var t = e.featureTarget.properties;
                        r.addCoordinate(t.coord_path, t.lng, t.lat), v(), _ = [t.coord_path]
                    },
                    I = function(e) {
                        0 === _.length ? E(e) : T()
                    },
                    S = function(t, n) {
                        d(e.store.getSelected(), n), i = t.lngLat
                    },
                    L = function(e, t) {
                        for (var n = _.map(function(e) {
                                return r.getCoordinate(e)
                            }), o = n.map(function(e) {
                                return {
                            ...
                            }), i = c(o, t), s = 0; s < n.length; s++) {
                            var a = n[s];
                            r.updateCoordinate(_[s], a[0] + i.lng, a[1] + i.lat)
                        }
                    };
                return {
                    start: function() {
                        e.store.setSelected(n), l.disable(e), this.on("mousemove", f.true, function(t) {
                            ...
                            return g
                        }, v), this.on("mousedown", h, O), this.on("mousedown", f.isActiveFeature, I), this.on("mousedown", y, x), this.on("drag", function() {
                            return m
                        }, function(e) {
                            g = !0, e.originalEvent.stopPropagation();
                            var t = {
                                lng: e.lngLat.lng - i.lng,
                                lat: e.lngLat.lat - i.lat
                            };
                            _.length > 0 ? L(e, t) : S(e, t), i = e.lngLat
                        }), this.on("click", f.true, T), this.on("mouseup", f.true, function() {
                            g && v(), T()
                        }), this.on("click", o, function() {
                            e.events.changeMode(p.modes.SIMPLE_SELECT)
                        }), this.on("click", s, function() {
                            e.events.changeMode(p.modes.SIMPLE_SELECT)
                        }), this.on("click", f.isActiveFeature, function() {
                            _ = [], r.changed()
                        })
                    },
                    stop: function() {
                    ...
                    render: function(t, r) {
                        n === t.properties.id ? (t.properties.active = p.activeStates.ACTIVE, r(t), u(t, {
                            map: e.map,
                            midpoints: !0,
                            selectedPaths: _
                        }).forEach(r)) : (t.properties.active = p.activeStates.INACTIVE, r(t)), b()
                    },
                    trash: function() {
                        _.sort().reverse().forEach(function(e) {
                            return r.removeCoordinate(e)
                        }), e.map.fire(p.events.UPDATE, {
                            action: p.updateActions.CHANGE_COORDINATES,
                            features: e.store.getSelected().map(function(e) {
                                return e.toGeoJSON()
                            })
                        }), _ = [], b(), r.isValid() === !1 && (e.store.delete([n]), e.events.changeMode(p.modes.SIMPLE_SELECT, {}))
                    }
                }
            }
        }, {
        ...
        53: [function(e, t, n) {
            ...
            t.exports = function(e) {
                var t = new o(e, {
                    ...
                    n = 0;
                return e._test && (e._test.line = t), e.store.add(t), {
                    start: function() {
                        e.store.clearSelected(), s.disable(e), e.ui.queueMapClasses({
                            mouse: a.cursors.ADD
                        }), e.ui.setActiveButton(a.types.LINE), this.on("mousemove", r.true, function(o) {
                            t.updateCoordinate(n, o.lngLat.lng, o.lngLat.lat), r.isVertex(o) && e.ui.queueMapClasses({
                                mouse: a.cursors.POINTER
                            })
                        }), this.on("click", r.true, function(r) {
                            return n > 0 && i(r, t.coordinates[n - 1]) ? e.events.changeMode(a.modes.SIMPLE_SELECT, {
                                featureIds: [t.id]
                            }) : (e.ui.queueMapClasses({
                                mouse: a.cursors.ADD
                            }), t.updateCoordinate(n, r.lngLat.lng, r.lngLat.lat), void n++)
                        }), this.on("click", r.isVertex, function() {
                            return e.events.changeMode(a.modes.SIMPLE_SELECT, {
                                featureIds: [t.id]
                            })
                        }), this.on("keyup", r.isEscapeKey, function() {
                            e.store.delete([t.id], {
                                silent: !0
                            }), e.events.changeMode(a.modes.SIMPLE_SELECT)
                    ...
                    stop: function() {
                        s.enable(e), e.ui.setActiveButton(), void 0 !== e.store.get(t.id) && (t.removeCoordinate("" + n), t.isValid() ? e.map.fire(a.events.CREATE, {
                    ...
                    render: function(e, n) {
                        ...
                        return e.properties.active = r ? a.activeStates.ACTIVE : a.activeStates.INACTIVE, r ? void(e.geometry.coordinates.length < 2 || (e.properties.meta = a.meta.FEATURE, e.geometry.coordinates.length >= 3 && n(u(t.id, e.geometry.coordinates[e.geometry.coordinates.length - 2], "" + (e.geometry.coordinates.length - 2), !1)), n(e))) : n(e)
                    },
                    trash: function() {
                        e.store.delete([t.id], {
                            silent: !0
                ...
                return e._test && (e._test.point = s), e.store.add(s), {
                    start: function() {
                        e.store.clearSelected(), e.ui.queueMapClasses({
                            mouse: i.cursors.ADD
                        }), e.ui.setActiveButton(i.types.POINT), this.on("click", r.true, n), this.on("keyup", r.isEscapeKey, t), this.on("keyup", r.isEnterKey, t), e.events.actionable({
                            combineFeatures: !1,
                            uncombineFeatures: !1,
                            trash: !0
                        })
                ...
                return e._test && (e._test.polygon = t), e.store.add(t), {
                    start: function() {
                        e.store.clearSelected(), i.disable(e), e.ui.queueMapClasses({
                            ...
                            return n > 0 && a(r, t.coordinates[0][n - 1]) ? e.events.changeMode(s.modes.SIMPLE_SELECT, {
                                featureIds: [t.id]
                            }) : (e.ui.queueMapClasses({
                                mouse: s.cursors.ADD
                            }), t.updateCoordinate("0." + n, r.lngLat.lng, r.lngLat.lat), void n++)
                        }), this.on("click", r.isVertex, function() {
            ...
            t.exports = function(e) {
                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                    ...
                    b = function() {
                        ...
                        t.length > 1 && ! function() {
                            r = !0;
                            var e = t[0].type.replace("Multi", "");
                            t.forEach(function(t) {
                                t.type.replace("Multi", "") !== e && (r = !1)
                            })
                        }();
                        var o = n.length > 0,
                            i = t.length > 0;
                ...
                return {
                    ...
                    start: function() {
                        e.store && (e.store.setSelected(_.filter(function(t) {
                            ...
                            return g
                        }, v), this.on("click", r.noTarget, function() {
                            var t = this,
                                n = e.store.getSelectedIds();
                            n.length && (e.store.clearSelected(), n.forEach(function(e) {
                                return t.render(e)
                            })), u.enable(e), T()
                        }), this.on("click", r.isOfMetaType(l.meta.VERTEX), function(t) {
        ...
        58: [function(e, t, n) {
            ...
            t.exports = function() {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                    t = o(e);
                return e.controls || (t.controls = {}), e.displayControlsDefault === !1 ? t.controls = o(u, e.controls) : t.controls = o(a, e.controls), t = o(s, t), t.styles = r(t.styles, "cold").concat(r(t.styles, "hot")), t
            }
        }, {
            "./constants": 24,
            "./lib/theme": 49,
        ...
        59: [function(e, t, n) {
            ...
            t.exports = function() {
                ...
                }), a = n.sources.hot.filter(function(e) {
                    return e.properties.id && s.indexOf(e.properties.id) === -1 && void 0 !== n.get(e.properties.id)
                }).map(function(e) {
                    return e.properties.id
                })), n.sources.hot = [];
                ...
                if (s.forEach(function(t) {
                        ...
                        return e(t, "cold")
                    }), c && n.ctx.map.getSource(r.sources.COLD).setData({
        ...
        61: [function(e, t, n) {
            ...
            var r = e("./lib/throttle"),
                ...
                a = t.exports = function(e) {
                    this._features = {}, this._featureIds = new i, this._selectedFeatureIds = new i, this._changedFeatureIds = new i, this._deletedFeaturesToEmit = [], this._emitSelectionChange = !1, this.ctx = e, this.sources = {
                        hot: [],
                        cold: []
                    }, this.render = r(s, 16, this), this.isDirty = !1
                };
            a.prototype.createRenderBatch = function() {
            ...
            }, a.prototype.featureChanged = function(e) {
                return this._changedFeatureIds.add(e), this
            }, a.prototype.getChangedIds = function() {
                return this._changedFeatureIds.values()
            }, a.prototype.clearChangedIds = function() {
                return this._changedFeatureIds.clear(), this
            }, a.prototype.getAllIds = function() {
                ...
                return o(e).forEach(function(e) {
                    t._featureIds.has(e) && (t._featureIds.delete(e), t._selectedFeatureIds.delete(e), n.silent || t._deletedFeaturesToEmit.indexOf(t._features[e]) === -1 && t._deletedFeaturesToEmit.push(t._features[e]), delete t._features[e], t.isDirty = !0)
                }), this
            ...
            }, a.prototype.deselect = function(e) {
                var t = this,
                    n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                return o(e).forEach(function(e) {
            ...
            }, a.prototype.setFeatureProperty = function(e, t, n) {
            ...
            t.exports = function(e) {
                ...
                function s(e) {
                    ...
                    return n.className = o.classes.CONTROL_BUTTON + " " + t.className, n.setAttribute("title", t.title), t.container.appendChild(n), n.addEventListener("click", function(n) {
                        ...
                        var r = n.target;
                        return r === f ? void a() : (u(e), void t.onActivate())
                    }, !0), n
                }
